...
LOG_FILE ?=
CACHE_DIR ?=
AUDIOWRT_PACKAGE_SMOKE ?= 0
AUDIOWRT_PACKAGE_SMOKE_PACKAGES ?=
...
build:
	...
	@AUDIOWRT_PROFILE="$(AUDIOWRT_PROFILE)" \
	 ...
	 LOG_FILE="$(LOG_FILE)" \
	 CACHE_DIR="$(CACHE_DIR)" \
	 AUDIOWRT_PACKAGE_SMOKE="$(AUDIOWRT_PACKAGE_SMOKE)" \
	 AUDIOWRT_PACKAGE_SMOKE_PACKAGES="$(AUDIOWRT_PACKAGE_SMOKE_PACKAGES)" \
