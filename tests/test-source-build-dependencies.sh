...
if grep -Eq '^(libc|audiowrt-sbc|audiowrt-bluez|audiowrt-btctl|bluez-daemon|sbc|libsndfile|libical|libreadline|libncurses)
...
if grep -Eq '^(sbc|libsndfile|audiowrt-sbc)
